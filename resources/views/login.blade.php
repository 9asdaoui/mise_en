            ...
            <div class="bg-gradient-to-r from-cuteblue to-cutepink p-4 text-center">
                <div class="h-32 flex items-center justify-center">
                    <svg class="w-24 h-24" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M70 120 Q100 145 130 120" stroke="#333" stroke-width="4" fill="none" />
                    </svg>
                </div>
                <h1 class="text-white font-bold text-2xl mt-2">Welcome Back!</h1>
            </div>
            ...
            <div class="p-8">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-center mb-2">
                            <label for="password" class="text-gray-600 text-sm font-medium">Password</label>
                            <a href="#" class="text-xs text-cuteblue hover:underline">Forgot password?</a>
                        </div>
                        <div class="relative">
                    ...
                    <div class="flex items-center mb-6">
                        <input id="remember-me" type="checkbox" class="h-4 w-4 accent-cutepink">
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-500">
                        ...
                        <a href="{{ route('register') }}" class="text-cuteblue hover:underline font-medium">Sign up</a>
                    </p>
                </div>
            </div>
        </div>
